...
def get_all_boxoffices() -> Response:
    return make_response(jsonify([boxoffice.put_into_dto() for boxoffice in boxoffice_controller.find_all_boxoffices()]), HTTPStatus.OK)


@boxoffice_bp.route('', methods=['POST'])
def create_boxoffice() -> Response:
